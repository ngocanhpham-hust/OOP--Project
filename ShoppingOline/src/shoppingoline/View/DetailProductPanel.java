...
import shoppingoline.Service.IntergrationService;
...
public class DetailProductPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panellmage.add(txtImage, java.awt.BorderLayout.PAGE_START);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(panellmage, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
    ...
    private void txtDetailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDetailActionPerformed
        ...
        String resultImg = intergrationService.getImgSuggest(this.product.getUrlImage());
        PrPanel.imgSuggest = resultImg;
        PrPanel.imgSuggests = Arrays.asList(resultImg.split(","));
